declare module "@apollo/client" {
  ...
  export class ApolloClient<TCache = any> {
  ...
  export function useSubscription(query: any, opts?: any): any;
  export function split(test: (op: any) => boolean, left: any, right: any): any;
