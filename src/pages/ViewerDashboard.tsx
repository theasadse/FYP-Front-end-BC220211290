...
import { Card, Row, Col, Statistic, Table, List, Spin, Typography, Tag } from 'antd'
import { EyeOutlined, FileTextOutlined, BarChartOutlined } from '@ant-design/icons'
import { useQuery } from '@apollo/client'
import { GET_DASHBOARD_STATS, ACTIVITIES } from '../graphql/operations/activities'
...
export default function ViewerDashboard() {
  ...
  const { data: activitiesData, loading: activitiesLoading } = useQuery(ACTIVITIES, {
    variables: { limit: 5 }
  })
  ...
  return (
    <div style={{ padding: '24px' }}>
      <Card 
        style={{ marginBottom: '24px', borderRadius: '8px', background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)' }}
